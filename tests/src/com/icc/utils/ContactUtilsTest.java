...
public class ContactUtilsTest extends TestCase {
	...
	private final String tStrFourContactsWithChars = "a#contact(0831236548), two-contacts, three&contacts, fo*r<con087147258tacts>";
	private final String tStrContactsWithPointlessSeparators = ", ,first contact, second contact,,, another contact, , ,";

	private final String tStrTwoContactsWithSemi = "first contact; last contact (084798465)";
	private final String tStrThreeContactsWithSemi = "first_0847898789_contact; second co086131313ntact, last contact";
	private final String tStrThreeContactsWithSemiAtEnd = "first contact(+35385114411), second contact; last contact";
	...
	public void testGetAllButLastContacts() {
		...
		assertEquals("a#contact(0831236548), two-contacts, three&contacts, ", ContactUtils.getAllButLastContacts(this.tStrFourContactsWithChars));
	...
	public void testGetLastContactWithSemiColon() {
		assertEquals("last contact (084798465)", ContactUtils.getLastContact(this.tStrTwoContactsWithSemi));
	...
	public void testTrimSeparators() {
		...
		assertEquals("a#contact(0831236548), two-contacts, three&contacts, fo*r<con087147258tacts>",
	...
	public void testTrimSeparatorsWithSemiColon() {
		...
		assertEquals("first contact, last contact (084798465)", ContactUtils.trimSeparators(this.tStrTwoContactsWithSemi));
